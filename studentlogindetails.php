...
<body>
    <main>
        ...
        <div class="d-flex flex-column p-3 text-dark bg-light" style="width: 80%; height: 100%;">
            <h1 class="bg-dark text-center  button-shadow text-shadow"
                style="margin-top:10px;margin-bottom:20px; padding:15px; border-radius:10px;">Student login details</h1>
                                        ...
                                        while($row = mysqli_fetch_assoc($result1))
                                            {
                                                echo '
                                                    <tr>
                                                        ...
                                                        <td scope="row"><a onClick=\'javascript: return confirm("Can you delete this login details?");\' href="deletelogin.php?email='.$row['email'].'"><input type="button" value="Delete" class="btn btn-danger button-shadow"></a></td>
                                                    </tr>';
                                                    $count++;
                                            }
                                            echo '</table>';
